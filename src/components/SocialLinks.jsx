...
const SocialLinks = () => {
    const links = [
        {
            ...
            href: "https://www.linkedin.com/in/sarala-r",
            style: "rounded-tr-md"
        },
        {
            id: 2,
            ...
            href: "https://github.com/sarala01",
        },
        {
            id: 3,
            child: (
            ...
            href: "mailto:saralark99@gmail.com",
        },
        {
            id: 4,
            child: (
    ...
    return (
        <div className='hiddenlg:flex flex-col top-[35%] left-0 fixed'>
            <ul>
